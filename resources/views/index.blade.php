...
@section('content')
    ...
    <section id="info">
            <div class="info_text">
                <h1>О нас</h1>
                <p>Мы — граждане, объединенные общей целью: сделать нашу страну<br> свободной от коррупции. Мы не профессиональная организация, но наша энергия, идеи и желание перемен вдохновляют нас на активные действия.</p>
